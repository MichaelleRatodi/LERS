...
public class Projet {
	...
	public static void main(String[] args) throws InstantiationException, IllegalAccessException {
		 ...
		 * Questionnaire(2, "Essai2", LocalDate.now(), LocalDate.now().plusDays(2), 2);
		 * abdd.insererObjet(quest); quest = new Questionnaire(3, "Essai3",
		 * LocalDate.now(), LocalDate.now().plusDays(2), 2); abdd.insererObjet(quest);
		 ...
		 * System.out.println(quests); System.out.println(quests.size());
